        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            ...
            <ul>
              ...
              <li><i class="bi bi-check-circle"></i> Music and Fun, Giveaways.</li>
              <li><i class="bi bi-check-circle"></i> Reactionrole, joinrole.</li>
              <li><i class="bi bi-check-circle"></i> Premium, Welcome messages.</li>
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="4996" data-purecounter-duration="1" class="purecounter"></span>
            <p>channels</p>
          </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6 mt-4">
                      <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="600">
                          <div class="png"><img src="assets/img/issage.png" height="200" width="200" class="img-fluid" alt=""></div>
                          <div class="member-info">
                              <h4>ISSAGE</h4>
                              <span>Designer</span>
                              <p>Professional Designer for our Astra bot. He is our first choice, if we need any new Designs to make Astra better.</p>
                              <div class="social">
          ...
          <ul>
            <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
              ...
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  You can disable the levelsystem with our (a!levelsystem off) command.
                </p>
              </div>
            </li>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              ...
              <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                <p>
                  You can use the (a!bug) command or just send a report to the specific channel in our discord support server.
                </p>
              </div>
            </li>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              ...
              <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                <p>
                  Currently you only get premium, if you won it in a giveaway or are a partner of our Bot
                </p>
              </div>
            </li>
            ...
            <li data-aos="fade-up" data-aos-delay="400">
              ...
              <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                <p>
                  You don't like the "a!" prefix? No problem! You can easily change the prefix with our (a!prefix) command
                </p>
              </div>
            </li>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              ...
              <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                <p>
                  Sometimes it happens that Astra goes offline, which is really normal! If he is offline for a long time, you can easily ask a team member.
                </p>
              </div>
            </li>
